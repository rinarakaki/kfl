...
#[test]
fn encode_argument_unnamed() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node(#[kfl(argument)] String);
    assert_encode!(Node("hello".into()), r#"node "hello""#);
    //     assert_encode_error!(Node,
    //         r#"node "hello" "world""#,
    //         "unexpected argument");
    //     assert_encode_error!(Node,
...
#[test]
fn encode_argument_default_named() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node {
...
#[test]
fn encode_argument_default_unnamed() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node(#[kfl(argument, default)] String);
    assert_encode!(Node("hello".into()), r#"node "hello""#);
    //     assert_encode_error!(Node,
    //         r#"node "hello" "world""#,
    //         "unexpected argument");
    assert_encode!(Node("".into()), r#"node"#);
}

#[test]
fn encode_argument_default_value_named() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node {
...
#[test]
fn encode_argument_default_option_value_named() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node {
...
#[test]
fn encode_property_unnamed() {
    #[derive(Decode, Encode, Debug, PartialEq, Default)]
    struct Node(#[kfl(property(name = "name"))] String);
    assert_encode!(Node("hello".into()), r#"node name="hello""#);
    //     assert_encode_error!(Node,
    //         r#"node name="hello" y="world""#,
    //         "unexpected property `y`");
    //     assert_encode_error!(Node,
...
fn encode_property_default() {
    ...
    assert_encode!(Node { name: "".into() }, r#"node"#);
}

#[test]
fn encode_property_default_value() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node {
...
#[test]
fn encode_property_default_option_value() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node {
    ...
    assert_encode!(Node { label: None }, r#"node label=null"#);
}

#[test]
fn encode_property_name() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node {
        #[kfl(property(name = "x"))]
        name: String,
...
fn encode_option_property() {
    ...
    assert_encode!(Node { name: None }, r#"node"#);
    // assert_encode!(Node { name: None },
    //                r#"node name=null"#);
}

#[test]
fn encode_var_arguments() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node {
        #[kfl(arguments)]
        params: Vec<u64>,
    ...
    assert_encode!(Node { params: vec![] }, r#"node"#);
}

#[test]
fn encode_var_properties() {
    #[derive(Decode, Encode, Debug, PartialEq)]
    struct Node {
        #[kfl(properties)]
...
fn encode_children() {
    ...
    // );
    assert_encode!(Parent { children: vec![] }, r#"parent"#);
...
fn encode_enum_unnamed() {
    ...
    assert_encode!(Enum::Var0, r#"var0"#);
    assert_encode!(Enum::Var1("hello".into()), r#"var1 "hello""#);
    assert_encode!(Enum::Var2("hello".into()), r#"var2 name="hello""#);
    // assert_encode_error!(Enum,
    //     r#"something"#,
    //     "expected one of `var0`, `var1`, `var2`");
}
...
fn encode_extra() {
    ...
    assert_encode!(Node { field: "".into() }, r#"node"#);
    // assert_encode_error!(Node,
    //     r#"node x=1"#,
